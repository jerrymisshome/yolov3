...
from nets.darknet53 import darknet53, conv_bn_leaky
...
def yolo_body():
    ...
    concat_feat26x26 = layers.Concatenate()([upsample_feat_26x26, feat_26x26])
    ...
    concat_feat_52x52 = layers.Concatenate()([upsample_feat_52x52, feat_52x52])
    ...
    model = models.Model(input_image, [output_13x13, output_26x26, output_52x52])
    # model.summary()
